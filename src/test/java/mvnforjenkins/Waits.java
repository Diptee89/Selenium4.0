...
//	implicitly Wait
	 ...
	 * It tells webdriver to wait for .. time befor moving to next command.
	 * once it's set,Global setting applicable to all element or full script .
	 * NoSuchElementExcetion Exception will after time; if not found
	 * */
